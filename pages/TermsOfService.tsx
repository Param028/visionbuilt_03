  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-20">
      <div className="text-center mb-12">
        ...
        <p className="text-foreground/50">Effective Date: {new Date().toLocaleDateString()}</p>
      </div>

      <div className="space-y-8">
        <Card className="p-8">
            <div className="flex items-center gap-3 mb-4 text-foreground/75">
                <FileText size={24} />
            ...
            <p className="text-foreground/75 mt-2 text-justify">
        ...
        <Card className="p-8">
            ...
            <p className="text-foreground/75 leading-relaxed mb-4 text-justify">
        ...
        <Card className="p-8">
            ...
            <ul className="list-disc list-inside text-foreground/60 space-y-2 ml-2 mt-2 text-justify">
        ...
        <Card className="p-8">
            <div className="flex items-center gap-3 mb-4 text-foreground/75">
                <CreditCard size={24} />
                <h2 className="text-xl font-bold text-foreground">4. Payment and Fees</h2>
            </div>
            <p className="text-foreground/75 leading-relaxed text-justify">
            ...
            <p className="text-foreground/75 mt-4 leading-relaxed text-justify">
            ...
            <p className="text-foreground/75 mt-4 text-justify">
                We maintain a strict refund policy to ensure fairness. For details regarding cancellations, eligible refunds, and non-refundable items, please refer to our full <Link to="/refund-policy" className="text-foreground font-semibold underline decoration-foreground/30 hover:decoration-foreground transition-all">Refund Policy</Link>.
            </p>
        </Card>
        ...
        <Card className="p-8">
            <div className="flex items-center gap-3 mb-4 text-foreground/75">
                <Database size={24} />
                <h2 className="text-xl font-bold text-foreground">5. Project Retention & Hosting</h2>
            </div>
            <p className="text-foreground/75 leading-relaxed text-justify">
            ...
            <p className="text-foreground/75 mt-2 leading-relaxed text-justify">
        ...
        <Card className="p-8 bg-content2 border border-divider">
            <div className="flex items-center gap-3 mb-4 text-foreground/75">
                <Mail size={24} />
            ...
            <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                 <div className="p-3 rounded-lg bg-content1 border border-divider">
                    <p className="text-xs text-foreground/45 uppercase">Email</p>
                    <p className="text-foreground font-mono mt-1">{INITIAL_CONTACT_INFO.email}</p>
                 </div>
                 <div className="p-3 rounded-lg bg-content1 border border-divider">
                    <p className="text-xs text-foreground/45 uppercase">Instagram</p>
                    <p className="text-foreground font-mono mt-1">@{INITIAL_CONTACT_INFO.instagram}</p>
                 </div>
            </div>
        </Card>
      </div>
