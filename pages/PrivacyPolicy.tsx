  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-20">
      <div className="text-center mb-12">
        ...
        <p className="text-foreground/50">Last Updated: {new Date().toLocaleDateString()}</p>
      </div>
      ...
      <div className="space-y-8">
        ...
        <Card className="p-8">
            ...
            <ul className="list-disc list-inside text-foreground/60 space-y-2 ml-2 text-justify">
        ...
        <Card className="p-8">
            ...
            <p className="text-foreground/75 leading-relaxed mt-4 text-justify">
        ...
        <Card className="p-8 bg-content2 border border-divider">
            ...
            <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-3 rounded-lg bg-content1 border border-divider">
                    <p className="text-xs text-foreground/45 uppercase">Email Support</p>
